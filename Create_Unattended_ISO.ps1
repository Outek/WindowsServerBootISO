...
Function Mount-StandardISO 
{
    ...
    Copy-Item -Path $driveLetter":\sources\install.wim" -Destination $Temp_Folder_WIM
...
Modify_autounattended_File -Hostname "SigiServer_1" -File_Path $autounattended_File_Path -Temp_Folder_Data $Temp_Folder_Data
